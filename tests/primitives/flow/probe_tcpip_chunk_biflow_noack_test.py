...
from netexp.primitives.flow import TCPIPChunkBiFlowNoackInfo
from netexp.common import naming


class TestTCPIPChunkBiFlowNoack(ProbeTCPIPFlowBase):

    flow_class = TCPIPChunkBiFlowNoackInfo
    ...
    def test_long_doh_flow_stats(self, probe_long_doh_flow):
        ...
        assert stats[f'3_{naming.ATTRIBUTE}'] == 39000
        assert stats[f'35_{naming.ATTRIBUTE}'] == 56000
        assert stats[f'38_{naming.ATTRIBUTE}'] == 78000
        assert stats[f'39_{naming.ATTRIBUTE}'] == 56000
